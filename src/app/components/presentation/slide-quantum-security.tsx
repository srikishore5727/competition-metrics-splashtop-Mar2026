        ...
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Dec 2025 to Feb 2026, keyword coverage remained stable <strong>3 → 3</strong>.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content={<>From Dec 2025 to Feb 2026, Palo Alto keywords remained stable <strong>4 → 4</strong>.</>}
            />
          </InsightsSection>
        );
      case 'page-one':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Dec 2025 to Feb 2026, page-1 rankings remained stable <strong>3 → 3</strong>.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content={<>From Dec 2025 to Feb 2026, Palo Alto page-1 rankings remained stable <strong>4 → 4</strong>.</>}
            />
          </InsightsSection>
        );
      case 'traffic':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Dec 2025 to Feb 2026, traffic doubled <strong>15 → 27 (+80.0%)</strong>, building growth momentum.</>}
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content={<>From Dec 2025 to Feb 2026, Palo Alto held steady <strong>128 → 128 (0%)</strong>, maintaining clear dominance.</>}
            />
          </InsightsSection>
        );
      case 'aio':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Dec 2025 to Feb 2026, AIO rankings remained stable <strong>1 → 1</strong>.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content={<>From Dec 2025 to Feb 2026, Palo Alto AIO rankings remained stable <strong>2 → 2</strong>.</>}
            />
          </InsightsSection>
        );
      default:
