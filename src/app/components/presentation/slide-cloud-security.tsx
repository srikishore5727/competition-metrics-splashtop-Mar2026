        ...
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="error"
              title="Fortinet"
              content={<>From Aug 2025 to Feb 2026, keywords Declined <strong>538 → 305</strong>.</>}
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content={<>From Aug 2025 to Feb 2026, Palo Alto Declined <strong>502 → 277</strong>.</>}
            />
          </InsightsSection>
        );
      case 'page-one':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Aug 2025 to Feb 2026, page-1 keywords increased <strong>109 → 206 (+89%)</strong>.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content={<>From Aug 2025 to Feb 2026, Palo Alto increased <strong>143 → 174 (+21.7%)</strong>.</>}
            />
          </InsightsSection>
        );
      case 'traffic':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Aug 2025 to Feb 2026, traffic increased <strong>13,433 → 138,334 (+929%)</strong>.</>}
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content={<>From Aug 2025 to Feb 2026, Palo Alto saw a drop from <strong>118,654 → 71,718</strong> despite strong enterprise search demand.</>}
            />
          </InsightsSection>
        );
      case 'aio':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Aug 2025 to Feb 2026, AIO keywords increased <strong>181 → 190 (+5%)</strong>.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content={<>From Aug 2025 to Feb 2026, Palo Alto increased <strong>164 → 165 (+0.6%)</strong>.</>}
            />
          </InsightsSection>
        );
      default:
