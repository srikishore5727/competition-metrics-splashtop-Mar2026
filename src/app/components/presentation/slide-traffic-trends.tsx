        ...
        <div className="col-span-4">
          <InsightsSection>
            <InsightCard
              icon={TrendingUp}
              type="success"
              content={<>Fortinet demonstrates <strong>+6.7%</strong> traffic growth (<strong>4.5M → 4.8M</strong>) from Oct to Jan, showing steady momentum. This indicates effective content strategy and improving organic visibility in the competitive landscape.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="info"
              content={<>Cisco shows volatile traffic pattern with a massive spike in November (<strong>33.5M</strong>) before dropping to <strong>4.5M</strong> by January. Crowdstrike experiences consistent decline (<strong>679K → 439K</strong>). Market presents opportunity for Fortinet to capture additional share.</>}
            />
          </InsightsSection>
        </div>
      </div>
