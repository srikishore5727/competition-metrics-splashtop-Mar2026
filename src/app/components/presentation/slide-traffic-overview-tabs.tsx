      ...
      return (
        <InsightsSection>
          <InsightCard
            ...
            type="success"
            title="Fortinet"
            content={<>From Jul 2025 to Feb 2026, traffic increased <strong>890K → 1.22M (+37%)</strong>, peaking at <strong>1.24M</strong> in Jan 2026.</>}
          />
          <InsightCard
            icon={TrendingUp}
            type="success"
            title="Competitions"
            content={<>From Jul 2025 to Feb 2026, Cisco remained the leader, with a slight decrease from <strong>1.9M → 1.8M</strong>, while Palo Alto grew <strong>296K → 635K (+115%)</strong>.</>}
          />
        </InsightsSection>
      );
      ...
      return (
        <InsightsSection>
          <InsightCard
            ...
            type="error"
            title="Fortinet"
            content={<>From Jul 2025 to Feb 2026, traffic declined <strong>158K → 93K (−41%)</strong>.</>}
          />
          <InsightCard
            icon={TrendingDown}
            type="error"
            title="Competitions"
            content={<>From Jul 2025 to Feb 2026, Cisco declined <strong>973K → 729K</strong>, while Palo Alto increased <strong>70K → 131K (+85%)</strong>.</>}
          />
        </InsightsSection>
      );
    } else {
      return (
        <InsightsSection>
          <InsightCard
            ...
            type="success"
            title="Fortinet"
            content={<>From Jul 2025 to Feb 2026, traffic increased <strong>731K → 1.13M (+54%)</strong>.</>}
          />
          <InsightCard
            icon={TrendingUp}
            type="success"
            title="Competitions"
            content={<>From Jul 2025 to Feb 2026, Cisco grew <strong>877K → 1.09M (+25%)</strong>, while Palo Alto increased <strong>225K → 504K (+124%)</strong>.</>}
          />
        </InsightsSection>
      );
    }
