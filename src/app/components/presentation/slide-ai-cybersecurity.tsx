        ...
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Dec 2025 to Feb 2026, keywords slightly increased <strong>32 → 33</strong>.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content={<>From Dec 2025 to Feb 2026, Palo Alto keywords increased <strong>35 → 41</strong>.</>}
            />
          </InsightsSection>
        );
      case 'page-one':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Dec 2025 to Feb 2026, page-1 rankings improved <strong>10 → 11</strong>.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content={<>From Dec 2025 to Feb 2026, Palo Alto page-1 rankings improved <strong>17 → 20</strong>.</>}
            />
          </InsightsSection>
        );
      case 'traffic':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Dec 2025 to Feb 2026, traffic grew <strong>959 → 1,435 (+49.6%)</strong>, securing the lead.</>}
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content={<>From Dec 2025 to Feb 2026, SentinelOne surged <strong>659 → 1,064 (+61.5%)</strong>, closing the gap.</>}
            />
          </InsightsSection>
        );
      case 'aio':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content={<>From Dec 2025 to Feb 2026, AIO rankings improved <strong>26 → 27</strong>.</>}
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content={<>From Dec 2025 to Feb 2026, Palo Alto AIO rankings increased <strong>27 → 33</strong>.</>}
            />
          </InsightsSection>
        );
      default:
